...
$delete_from_filled="DELETE FROM filled_surveys WHERE filled_surveys.survey_id=$surveyid";

$delete_from_filled="DELETE FROM filled_surveys WHERE filled_surveys.survey_id=$surveyid";
$mysqli->query($delete_from_filled);

$date=date('d-m-Y');
$query="INSERT INTO `done_surveys`(`done_id`, `survey_id`, `done_date`) VALUES ('','$surveyid','$date')";
